...
BEGIN
    ...
    INSERT INTO Y24GROUP054.PARENT_TYPE("TYPE_ID", "TYPE_NAME", "BASE_DAILY_RATE", "WAITLIST_PRIORITY_LEVEL") VALUES (4, 'Previous UNSW', 170, 4);
...
BEGIN
    INSERT INTO Y24GROUP054.SDN_EMPLOYEE_PARENT("PARENT_ID", "EMPLOYEE_ID") VALUES(500000, 400005);
    INSERT INTO Y24GROUP054.SDN_EMPLOYEE_PARENT("PARENT_ID", "EMPLOYEE_ID") VALUES(500001, 400006);
    INSERT INTO Y24GROUP054.SDN_EMPLOYEE_PARENT("PARENT_ID", "EMPLOYEE_ID") VALUES(500002, 400007);
    INSERT INTO Y24GROUP054.SDN_EMPLOYEE_PARENT("PARENT_ID", "EMPLOYEE_ID") VALUES(500003, 400008);
    INSERT INTO Y24GROUP054.SDN_EMPLOYEE_PARENT("PARENT_ID", "EMPLOYEE_ID") VALUES(500004, 400009);
    INSERT INTO Y24GROUP054.SDN_EMPLOYEE_PARENT("PARENT_ID", "EMPLOYEE_ID") VALUES(500005, 400010);

    INSERT INTO Y24GROUP054.UNSW_PHD_PARENT("PARENT_ID", "ZID") VALUES(500006, 'z1234567');
    INSERT INTO Y24GROUP054.UNSW_PHD_PARENT("PARENT_ID", "ZID") VALUES(500007, 'z9876543');
    INSERT INTO Y24GROUP054.UNSW_PHD_PARENT("PARENT_ID", "ZID") VALUES(500008, 'z0000001');
    INSERT INTO Y24GROUP054.UNSW_PHD_PARENT("PARENT_ID", "ZID") VALUES(500009, 'z1111111');
    INSERT INTO Y24GROUP054.UNSW_PHD_PARENT("PARENT_ID", "ZID") VALUES(500010, 'z9999999');

    INSERT INTO Y24GROUP054.UNSW_STAFF_PARENT("PARENT_ID", "ZID") VALUES(500011, 'z8765432');
    INSERT INTO Y24GROUP054.UNSW_STAFF_PARENT("PARENT_ID", "ZID") VALUES(500012, 'z5555555');
    INSERT INTO Y24GROUP054.UNSW_STAFF_PARENT("PARENT_ID", "ZID") VALUES(500013, 'z4444444');
    INSERT INTO Y24GROUP054.UNSW_STAFF_PARENT("PARENT_ID", "ZID") VALUES(500014, 'z7777777');
    INSERT INTO Y24GROUP054.UNSW_STAFF_PARENT("PARENT_ID", "ZID") VALUES(500015, 'z2222222');

    INSERT INTO Y24GROUP054.PREVIOUS_UNSW_PARENT("PARENT_ID", "ZID", "LEAVE_DATE") VALUES(500016, 'z3333333', '17-Sep-2023');
    INSERT INTO Y24GROUP054.PREVIOUS_UNSW_PARENT("PARENT_ID", "ZID", "LEAVE_DATE") VALUES(500017, 'z8888888', '01-Feb-2024');
    INSERT INTO Y24GROUP054.PREVIOUS_UNSW_PARENT("PARENT_ID", "ZID", "LEAVE_DATE") VALUES(500018, 'z6543210', '19-Nov-2023');
    INSERT INTO Y24GROUP054.PREVIOUS_UNSW_PARENT("PARENT_ID", "ZID", "LEAVE_DATE") VALUES(500019, 'z1357924', '29-Jan-2024');
    INSERT INTO Y24GROUP054.PREVIOUS_UNSW_PARENT("PARENT_ID", "ZID", "LEAVE_DATE") VALUES(500020, 'z2468013', '26-Jun-2023');
    COMMIT;
END;
/
