...
BEGIN
    ...
    INSERT INTO Y24GROUP054.CHILD_MEDICATION("CHILD_ID", "MEDICATION_ID", "DOSAGE_MG", "FREQUENCY", "DESCRIPTION") VALUES (1000012, 1, 326.08, 'twice daily','allergies');
    INSERT INTO Y24GROUP054.CHILD_MEDICATION("CHILD_ID", "MEDICATION_ID", "DOSAGE_MG", "FREQUENCY", "DESCRIPTION") VALUES (1000012, 2, 224.97, 'hourly','growth supplement');
    INSERT INTO Y24GROUP054.CHILD_MEDICATION("CHILD_ID", "MEDICATION_ID", "DOSAGE_MG", "FREQUENCY", "DESCRIPTION") VALUES (1000016, 3, 241.68, 'every two hours','headaches');
    INSERT INTO Y24GROUP054.CHILD_MEDICATION("CHILD_ID", "MEDICATION_ID", "DOSAGE_MG", "FREQUENCY", "DESCRIPTION") VALUES (1000014, 7, 367.15, 'daily','bellyaches');
    INSERT INTO Y24GROUP054.CHILD_MEDICATION("CHILD_ID", "MEDICATION_ID", "DOSAGE_MG", "FREQUENCY", "DESCRIPTION") VALUES (1000017, 4, 20.02, 'every two hours','headaches');
    INSERT INTO Y24GROUP054.CHILD_MEDICATION("CHILD_ID", "MEDICATION_ID", "DOSAGE_MG", "FREQUENCY", "DESCRIPTION") VALUES (1000014, 1, 370.2, 'hourly','growth supplement');
    INSERT INTO Y24GROUP054.CHILD_MEDICATION("CHILD_ID", "MEDICATION_ID", "DOSAGE_MG", "FREQUENCY", "DESCRIPTION") VALUES (1000017, 7, 196.37, 'every thirty minutes','every thirty minutes');
    INSERT INTO Y24GROUP054.CHILD_MEDICATION("CHILD_ID", "MEDICATION_ID", "DOSAGE_MG", "FREQUENCY", "DESCRIPTION") VALUES (1000014, 9, 954.33, 'twice daily','allergies');
    INSERT INTO Y24GROUP054.CHILD_MEDICATION("CHILD_ID", "MEDICATION_ID", "DOSAGE_MG", "FREQUENCY", "DESCRIPTION") VALUES (1000019, 7, 656.51, 'every two hours','headaches');
    INSERT INTO Y24GROUP054.CHILD_MEDICATION("CHILD_ID", "MEDICATION_ID", "DOSAGE_MG", "FREQUENCY", "DESCRIPTION") VALUES (1000011, 7, 923.53, 'twice daily','allergies');
END;
/
-- Populate Room table
BEGIN
