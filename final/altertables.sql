...
ADD (
    CONSTRAINT C_ROLL_ID_PK PRIMARY KEY ("ROLL_ID") ENABLE,
...
ADD (
    CONSTRAINT RCRD_ID_PK PRIMARY KEY ("RECORD_ID") ENABLE,
...
ADD (
    CONSTRAINT CLASS_ID_PK PRIMARY KEY ("CLASS_ID") ENABLE,
